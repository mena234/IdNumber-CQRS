...
using Salary.API.Application.Validations;
using Salary.API.Application.Behaviors;
using Salary.API.DomainEventHandler.SalaryAccordingDay;
...
namespace Microsoft.eShopOnContainers.Services.Ordering.API.Infrastructure.AutofacModules
{
    public class MediatorModule : Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterAssemblyTypes(typeof(CreateSalaryCommand).GetTypeInfo().Assembly)
